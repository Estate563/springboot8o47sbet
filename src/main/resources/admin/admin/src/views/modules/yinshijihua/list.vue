			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">计划名称</label>
						<el-input v-model="searchForm.jihuamingcheng" placeholder="计划名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">计划日期</label>
						<el-date-picker v-model="searchForm.jihuariqistart" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="计划日期起始"></el-date-picker>
						至
						<el-date-picker v-model="searchForm.jihuariqiend" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="计划日期结束"></el-date-picker>
					</div>
		...
		methods: {
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.jihuariqistart!='' && this.searchForm.jihuariqistart!=undefined ){
					params['jihuariqistart'] = this.searchForm.jihuariqistart
				}
				if(this.searchForm.jihuariqiend!='' && this.searchForm.jihuariqiend!=undefined){
					params['jihuariqiend'] = this.searchForm.jihuariqiend
				}
