<template>
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__bounce' v-if="pageFlag=='security1'">
				<div class="rgs-form2">
			...
			<el-form class='rgs-form animate__animated animate__bounce' v-if="pageFlag=='security2'">
				<div class="rgs-form2">
					<div class="title">找回密码</p></div>
			...
			<el-form class='rgs-form animate__animated animate__bounce' v-if="pageFlag=='security3'">
				<div class="rgs-form2">
					<div class="title">找回密码</p></div>
			...
			<el-form class='rgs-form animate__animated animate__bounce' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot+Vue个人健康管理系统的设计与实现注册</p></div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.container {
		background: url(http://codegen.caihongy.cn/20250203/de11b8f2ba364b1f94f26c9266be1dd5.png) center center/100% 100%;
		display: flex;
		width: 100%;
		min-height: 100vh;
		...
		background: url(http://codegen.caihongy.cn/20250203/de11b8f2ba364b1f94f26c9266be1dd5.png) center center/100% 100%;
		.rgs-form {
			border: 10px solid #B177D550;
			border-radius: 90px;
			padding: 40px 20px 40px;
			box-shadow: inset 0px -30px 4px 0px rgba(255, 255, 255, 0.25);
