<template>
	<div :style='{"width":"100%","padding":"20px 16%","margin":"10px auto","position":"relative","background":"#fff"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"margin":"0 auto 40px","color":"#000","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250204/dea0da8558ec43668514abc9cb06b051.png) center center/100% 100%","display":"block","width":"400px","fontSize":"26px","lineHeight":"70px","fontWeight":"bold","height":"70px"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"0 16%","margin":"10px auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","width":"100%","fontWeight":"500","order":"5"}'
